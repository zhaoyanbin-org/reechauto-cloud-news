...
public enum IsAnsweredEnum {
	...
	IsAnsweredEnum(String value, String text) {
		this.value = value;
		this.text = text;
	}
	...
	public static IsAnsweredEnum get(String enumValue) {
		IsAnsweredEnum[] var1 = values();
		int var2 = var1.length;
		for (int var3 = 0; var3 < var2; ++var3) {
			IsAnsweredEnum em = var1[var3];
