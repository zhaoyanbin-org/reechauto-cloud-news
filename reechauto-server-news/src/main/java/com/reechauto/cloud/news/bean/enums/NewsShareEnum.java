...
public enum NewsShareEnum {
	...
	NewsShareEnum(String value, String text) {
		this.value = value;
		this.text = text;
	}
	...
	public static NewsShareEnum get(String enumValue) {
		NewsShareEnum[] var1 = values();
		int var2 = var1.length;
		for (int var3 = 0; var3 < var2; ++var3) {
			NewsShareEnum em = var1[var3];
