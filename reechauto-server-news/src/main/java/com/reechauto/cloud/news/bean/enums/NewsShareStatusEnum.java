 ...
 *
 */
public enum NewsShareStatusEnum {
	Y("Y", "正常"), N("N", "删除");
	
	private static final Map<String, String> MAPPING = new LinkedHashMap<String, String>();
	
	static {
		for (NewsShareStatusEnum em : NewsShareStatusEnum.values()) {
	...
	NewsShareStatusEnum(String value, String text) {
		this.value = value;
		this.text = text;
	}
	...
	public static NewsShareStatusEnum get(String enumValue) {
		NewsShareStatusEnum[] var1 = values();
		int var2 = var1.length;
		for (int var3 = 0; var3 < var2; ++var3) {
			NewsShareStatusEnum em = var1[var3];
